...
pd_city_populations = read_csv(census_city_populations_2010_filename, encoding='ISO-8859-1')
...
pd_city_areas.rename(columns={'GCT_STUB.target-geo-id2': 'GC_RANK.target-geo-id2'}, inplace=True)

pd_combined_data = pd_city_populations.merge(pd_city_areas, on='GC_RANK.target-geo-id2', how='outer')
